...
\begin{exemple}
  % TODO: enlever les coordonnées pour la version élève
  Dans le repère juste au-dessus, les coordonnées des points $O$, $I$, $J$, et
  $M$ sont respectivement $(0;0)$, $(1;0)$, $(0;1)$ et $(2; -1)$.
\end{exemple}
...
\begin{exemple}
  ...
  \begin{minipage}{.5\textwidth}
    \begin{itemize}
      \item L'ordonnée du point $A$ est $2$.
      \item L'abscisse du point $B$ est $0$.
      \item Les coordonnées de $C$ sont $(-2; 0)$.
      \item Les coordonnees de $D$ sont $(-1; 2)$.
    \end{itemize}
\end{minipage}
  \begin{minipage}{.5\textwidth}
    \begin{center}
...
%TODO: autre exemple dans un repère non orthonormé, pour voir l'intérêt
