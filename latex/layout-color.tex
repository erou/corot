...
\newenvironment{rmq}
  {
    \begin{bclogo}[logo=\bcinfo, noborder=true, margeG=-0.33]{Remarque}
  }
  {
    \end{bclogo}\ignorespacesafterend
  }

% Defining the method environment
% ===============================

\newenvironment{methode}
  {
    \begin{bclogo}[logo=\bcoutil, noborder=true, margeG=-0.33]{Méthode}
  }
  {
    \end{bclogo}
  }
...
\newenvironment{oldexo}
  {
    \begin{bclogo}[logo=\bccrayon, noborder=true, margeG=-0.33]{Exercice \theexos}
  }
  {
    \end{bclogo}
    \addtocounter{exos}{1}
