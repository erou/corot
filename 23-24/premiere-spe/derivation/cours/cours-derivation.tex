...
% ====
%
% Dans le tableau, peut-être éviter de mettre les formules du style (uv)' =
% u'v+uv' car ensuite les élèves écrivent ça dans leurs calculs. Normalement il
% y a la place pour ajouter f(x)=u(x)v(x) puis f'(x) = ... dedans.
