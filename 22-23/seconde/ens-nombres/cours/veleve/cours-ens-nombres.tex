...
\newcommand{\titrechapitre}{Ensembles de nombres -- Cours}
...
\begin{defi}{Diviseurs et multiples}
  ...
  dit que $a$ est un \emph{diviseur} de $b$ \phantom{s'il existe $k\in\mathbb{Z}$ tel
que}
  \[
    \phantom{b = k\times a.}
  \]
  ...
  \begin{itemize}
    \item $b$ est un \hspace{2cm}\phantom{\emph{multiple}} de $a$;
    \item $a$ \hspace{2cm}\phantom{\emph{divise}} $b$;
    \item $b$ est \hspace{2cm}\phantom{\emph{divisible}} par $a$.
  \end{itemize}
\end{defi}
\begin{exemple}
  \begin{enumerate}
...
\begin{defi}{Nombres pairs ou impairs}
  ...
  \begin{itemize}
    \item \emph{pair} \phantom{s'il existe $k\in\mathbb{Z}$ tel que $a=2\times
    k$;}
    \item \emph{impair} \phantom{s'il existe $k\in\mathbb{Z}$ tel que $a=2\times
    k+1$.}
  \end{itemize}
\end{defi}
\begin{rmq}
