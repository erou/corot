...
\newcommand{\titrechapitre}{Trigonométrie -- Cours}
...
% ====
%
% Rajouter une remarque sur les angles négatifs en radian et comment les
% traduire en degré (à faire dans le TD peut-être surtout)
